...
export function deriveSearchParams(houseProfile) {
  ...
  // ── Budget ────────────────────────────────────────────────────────────────
  // Note: budget params are intentionally excluded from the demo/onboarding
  // fetch to avoid empty results in high-price markets. Budget filtering
  // applies only on the main listings page after profile is established.
